...
impl Default for EquipmentWindow {
    fn default() -> Self {
        Self {
            id: "equipment_window".to_owned(),
            button_name: "Equipment".to_owned(),
            window_name: "Equipment Window".to_owned(),
        }
    }
}

impl WindowComponent for EquipmentWindow {
...
impl Component for EquipmentWindow {
