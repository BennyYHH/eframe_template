...
pub struct SaveLoadWindow {
    id: String,
    button_name: String,
    window_name: String,
}

impl Default for SaveLoadWindow {
    fn default() -> Self {
        Self {
            id: "save_load_window".to_owned(),
            button_name: "Save/Load".to_owned(),
            window_name: "Save/Load Window".to_owned(),
        }
    }
}

impl WindowComponent for SaveLoadWindow {
...
impl Component for SaveLoadWindow {
