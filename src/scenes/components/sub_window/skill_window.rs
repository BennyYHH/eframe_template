...
impl Default for SkillWindow {
    fn default() -> Self {
        Self {
            id: "skill_window".to_owned(),
            button_name: "Skill".to_owned(),
            window_name: "Skill Window".to_owned(),
        }
    }
}

impl WindowComponent for SkillWindow {
...
impl Component for SkillWindow {
